...
myUtil = {
    ...
    xDecode: function (o) {
        return null == o || "" == o ? o : o.replace(/\\x(\w{2})/g, function (o, n) {
            return String.fromCharCode(parseInt(n, 16))
        })
    },
    xEncode: function (o) {
        return null == o || "" == o ? o : o.replace(/(\S)/g, function (o, n) {
            return "\\x" + n.charCodeAt(0).toString(16)
        })
    },
    isPC: function () {
        for (var o = navigator.userAgent, n = ["Android", "iPhone", "SymbianOS", "Windows Phone", "iPad", "iPod"], i = !0, t = 0; t < n.length; t++)
            if (0 < o.indexOf(n[t])) {
                i = !1;
                break
            } return i
    ...
    init: function () {
        window.console && console.log("%c ", "background: url(https://zhousiwei.gitee.io/img/linux_logo.jpg) no-repeat center;padding-left:1366px;padding-bottom: 490px;"), this.isPC() && window.console && (this.customLogInfo("---联系方式  > > >  QQ：2434387555---"), this.customLogInfo("試毅-思伟，Java软件工程师，三年Java EE 从业经验，目前在杭州工作。\n主要技能点：Java后端开发、Spring Cloud微服务、聚合支付、公众号开发、小程序开发、Linux\n欢迎来到`試毅-思伟`的技术博客，这里将深入探讨相关技术，包括行业动态，架构设计，设计模式，框架使用等。\n\n----------------友链----------------\n\n技术笔记：https://zhousiwei.gitee.io/ibooks\n技术博客：https://zhousiwei.gitee.io/\n个人简历：https://zhousiwei.gitee.io/anires/index.html\nGitHub：https://github.com/JoeyBling\n简书：https://www.jianshu.com/u/02cbf31a043a"))
    },
